...
//
              self.viewControllers![0].tabBarItem.image = UIImage(imageLiteralResourceName: "Search_Unselected").withRenderingMode(.alwaysOriginal)
              self.viewControllers![0].tabBarItem.selectedImage = UIImage(imageLiteralResourceName: "Search_Selected").withRenderingMode(.alwaysOriginal)
              self.viewControllers![0].tabBarItem.imageInsets = UIEdgeInsets(top: inset, left: inset, bottom: inset, right: inset)
              
              
              self.viewControllers![1].tabBarItem.image = UIImage(imageLiteralResourceName: "Library_Unselected").withRenderingMode(.alwaysOriginal)
              self.viewControllers![1].tabBarItem.selectedImage = UIImage(imageLiteralResourceName: "Library_Selected").withRenderingMode(.alwaysOriginal)
